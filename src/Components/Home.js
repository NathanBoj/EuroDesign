...
export default function Home() {
    return (
        <section id="Home" className="h-screen"
            style={{
                backgroundImage: `url(${process.env.PUBLIC_URL}/wall.svg)`,
            ...
            <div className="flex items-center justify-center py-54 ">
                <div id="default-carousel" class="relative w-4/5 h-5/6" data-carousel="slide">
                    ...
                    <div class="relative overflow-hidden rounded-lg md:h-96">
                        ...
                        <div class="hidden duration-700 ease-in-out" data-carousel-item>
                            <img
                                ...
                                class="absolute block w-full -translate-x-2/3 -translate-y-2/3 top-2/3 left-2/3"
                                alt="..."
                            />
                        </div>
